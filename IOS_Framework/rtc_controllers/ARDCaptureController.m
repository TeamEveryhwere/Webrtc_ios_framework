...
@interface ARDCaptureController () <RTCVideoCapturerDelegate>
@end
...
- (void)capturer:(RTCVideoCapturer *)capturer didCaptureVideoFrame:(RTCVideoFrame *)frame {
    NSLog(@"ARDCaptureController didCaptureVideoFrame");
}
...
//        maxFramerate = fmax(maxFramerate, fpsRange.minFrameRate);
    }
    maxFramerate = 25;
    return maxFramerate;
}
